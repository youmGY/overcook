"""
웹캠으로 finger_5 랜드마크 수집

Space: 현재 프레임의 랜드마크 저장
q / ESC: 종료 & 저장

사용법:
    python train/collect_finger5.py
출력:
    train/landmarks_finger5.npz  (landmarks, labels, handedness)
    기존 파일이 있으면 이어서 저장.
"""
...
def main():
    ...
    save_path = os.path.join(base_dir, 'landmarks_finger5.npz')
